...
<head>
    ...
    <!-- Title Page-->
    <title>Gestions des fornisseurs</title>
        ...
        <div class="page-container">
            ...
            <!-- END HEADER DESKTOP-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Fornisseurs</h3>
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="property">
                                                <option selected="selected">trier</option>
                                                <option value=""> <a href="trieNom.php"> Nom </a></option>
                                                <option value=""> <a href="trieDate.php"> date </a> </option> 
                                               <!--  <a href="trieDate.php"> chercher </a> --> 
                                            </select>
                                        ...
                                        <button class="au-btn-filter">
                                            <i class="zmdi zmdi-filter-list"></i>Chercher</button>
                                    </div>
                                    <div class="table-data__tool-right">
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small" >
                                            <a class="zmdi zmdi-plus" href="fournisseur.html" > Ajouter</a> </button>
...
foreach($liste as $row){
	...
	<td>
	<a href="supprimerFornisseur.php?Nom=<?PHP echo $row['Nom']; ?>">
	supprimer</a> 
 
        </td>
	<td><a href="modifierFornisseur.php?Nom=<?PHP echo $row['Nom']; ?>">
	Modifier</a></td>
	</tr>
	<?PHP
}
