...
<head>
    ...
    <!-- Title Page-->
    <title>Ajout d'un livreur</title>
...
<body>
     <form action="ajouterliv.php" method="post" nctype="multipart/form-data">
        <br>
        <br>
                        ...
                        <input type="number" class="form-control" id="success" name="cin" value=""/>
                    </div>
                        ...
                        <input type="text" class="form-control" id="warning" name="nom" value=""/>
                    </div>
                        ...
                        <input type="text" class="form-control" id="error" name="prenom" value=" "/>
                    </div>
