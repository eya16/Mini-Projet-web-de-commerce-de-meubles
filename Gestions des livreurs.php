...
$lC=new livreurC();
$listelivreur =$lC->afficherlivreurs();
if(isset($_POST['search']))
{
    $keywords = $_POST['keywords'];
    $listelivreur=$lC->getAllLivreurS($keywords);
}
else if(isset($_POST['filtre']))
{
   $xx= $_POST['xx'];
    $listelivreur=$lC->getOrderPromotionT($xx);
}
else
{
    $listelivreur =$lC->afficherlivreurs();
...
<!DOCTYPE html>
    ...
    <!-- Title Page-->
    <title>Gestions des livreurs</title>
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="Gestion des livraisons.php">
                                <i class="fas fa-chart-bar"></i>Gestion des livraisons</a>
                        </li>
                        <li>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="Gestions des livraisons.php">
                                <i class="fas fa-group (alias)"></i>Gestions des livraisons</a>
                        </li>
                        <li>
                            <a href="Gestion des produits.html">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                 ...
                                 <h3 class="title-5 m-b-35">livreurs</h3>
                                <div class="table-data__tool">
                                   ...
                                   <div class="table-data__tool-right">
                                        <input class="au-btn au-btn-icon au-btn--green au-btn--small" type=button value="Ajouter" onClick="javascript:popUp('ajoutlivreur.php')">
...
<button class="item" data-toggle="tooltip" data-placement="top" title="Supprimer">
    <a href="supprimerlivreur.php?delid=<?php echo $row['cin'];?>">
     <i class="zmdi zmdi-delete"></i>
</a>
 </button>

 <button class="item" data-toggle="tooltip" data-placement="top" title="modifier">
    <a href="modifierlivreur.php?editid=<?php echo $row['cin'];?>">
