                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">Islam Ouselati </a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#">jIslam Oueslati</a>
                                                    </h5>
                                                    <span class="email">Islam Oueslati @example.com</span>
                                                </div>
                                            </div>
...
<tr>
<td>date</td>
<td><input type="text" name="dateEmis" value="<?PHP echo $dateEmis ?>"></td>
</tr>
<tr>
<td>etat</td>
...
<td></td>
                ...
                <div class="form-group" style="align=center">
                        ...
                        <input type="hidden" name="idCom_ini" value="<?PHP echo $_GET['idCom'];?>">
                </div>
</form>
