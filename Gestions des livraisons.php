...
$livC=new livraisonC();
$listelivraison =$livC->afficherlivraisons();
if(isset($_POST['search']))
{
    $keywords = $_POST['keywords'];
    $listelivraison=$livC->getAllLivraisonS($keywords);
}
else
{
    $listelivraison =$livC->afficherlivraisons();
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="Gestion des livreurs.php">
                                <i class="fas fa-chart-bar"></i>Gestion des livreurs</a>
                        </li>
                        <li>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="Gestions des livreurs.php">
                                <i class="fas fa-group (alias)"></i>Gestions des livreurs</a>
                        </li>
                        <li>
                            <a href="Gestion des produits.html">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                 ...
                                 <h3 class="title-5 m-b-35">livraisons</h3>
...
<button class="item" data-toggle="tooltip" data-placement="top" title="Supprimer">
    <a href="supprimerlivraison.php?delid=<?php echo $row['id'];?>">
     <i class="zmdi zmdi-delete"></i>
</a>
 </button>

 <button class="item" data-toggle="tooltip" data-placement="top" title="Modifier">
    <a href="modifierlivraison.php?editid=<?php echo $row['id'];?>">
