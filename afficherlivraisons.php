                ...
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                         ...
                         <li>
                            <a href="Gestions des livraisons.html">
                                <i class="fas fa-bell"></i>Gestions des livraison</a>
                        </li>
                         <a href="mail.html">
                                <i class="fas fa-bell"></i>mail</a>
                        </li>
                        <li>
                            <a href="Gestions des livreur.html">
                                <i class="fas fa-bookmark"></i>Gestions des livreurs</a>
                        </li>
