...
<!-- Mirrored from www.spruko.com/demo/splite/affichercommande.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Feb 2019 18:34:41 GMT -->
<head>
			...
			<div class="main-wrapper" >
				...
				<aside class="app-sidebar">
					<div class="app-sidebar__user">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fa fa-table"></i><span class="side-menu__label">Gestion commande</span></a>
							<ul class="slide-menu">
								<li><a href="stat.html" class="slide-item">static</a></li>
								<li><a href="historique.php" class="slide-item">Historique</a></li>
								<li><a href="affichercommande.php" class="slide-item">Commandes</a></li>
							</ul>
						</li>
				...
				<div class="app-content">
					<section class="section">
						...
						<div class="page-header">
							<h4 class="page-title">Les commandes</h4>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#" class="text-light-color">Gestion commande</a></li>
...
<!-- Mirrored from www.spruko.com/demo/splite/affichercommande.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Feb 2019 18:34:42 GMT -->
</html>
<?php
  }
?>
